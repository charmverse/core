/*
  ...
  - The values [vote,review] on the enum `ProposalOperation` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ProposalOperation_new" AS ENUM ('edit', 'view', 'view_private_fields', 'delete', 'create_vote', 'comment', 'make_public', 'evaluate', 'archive', 'unarchive', 'move');
