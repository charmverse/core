import { User, SpaceRole, UserWallet, UnstoppableDomain, GoogleAccount, VerifiedEmail, DiscordUser, TelegramUser, UserNotificationState, SpaceRoleToRole, Role } from "@prisma/client";
